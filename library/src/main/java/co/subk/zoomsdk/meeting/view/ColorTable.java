...
import co.subk.zoomsdk.meeting.interfaces.IColorChangedListener;
import co.subk.zoomsdk.meeting.util.AppUtil;
...
public class ColorTable extends View {
	...
	private void init() {
		...
		circleSize =  AppUtil.dip2px(mContext, DFT_COLORS_CIRCLE_SIZE);
		space = AppUtil.dip2px(mContext, DFT_COLORS_CIRCLE_SPACE);
	}
